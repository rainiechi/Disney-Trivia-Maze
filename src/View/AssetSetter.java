...
public class AssetSetter {
    ...
    private final ObjectManager[] myObjManagers;
    ...
    public AssetSetter(final ObjectManager[] theObjManager) {
        this.myObjManagers = theObjManager;
        try {
            setWhiteDoors();
            setChests();
            setSideDoors();
    ...
    private void setWhiteDoors() {
        ...
        for (int i = 0; i <= 19; i++) {
            ...
            myObjManagers[i] = new ObjectManager("Door", x * TILE_SIZE, y * TILE_SIZE, true);
            y += 13;
    ...
    private void ExitLocation() {
        ...
        myObjManagers[20] = new ObjectManager("Exit", 38 * TILE_SIZE, 1 * TILE_SIZE, true);
    }
    ...
    private void setSideDoors() {
        ...
        for (int i = 21; i <= 52; i++) {
            ...
            // or skip a column.
            myObjManagers[i] = new ObjectManager("SideDoor", x * TILE_SIZE, y * TILE_SIZE, true);
            if (count == 2) {
                x += 8;
                count = 0;
            } else {
    ...
    private void setChests() {
        myObjManagers[53] = new ObjectManager("Chest", 8 * TILE_SIZE, 2 * TILE_SIZE, true);
        myObjManagers[54] = new ObjectManager("Chest", 53 * TILE_SIZE, 16 * TILE_SIZE, true);
        myObjManagers[55] = new ObjectManager("Chest", 23 * TILE_SIZE, 16 * TILE_SIZE, true);
        myObjManagers[56] = new ObjectManager("Chest", 8 * TILE_SIZE, 29 * TILE_SIZE, true);
        myObjManagers[57] = new ObjectManager("Chest", 68 * TILE_SIZE, 2 * TILE_SIZE, true);
        myObjManagers[58] = new ObjectManager("Chest", 23 * TILE_SIZE, 55 * TILE_SIZE, true);
        myObjManagers[59] = new ObjectManager("Chest", 68 * TILE_SIZE, 29 * TILE_SIZE, true);
        myObjManagers[60] = new ObjectManager("Chest", 53 * TILE_SIZE, 42 * TILE_SIZE, true);
    }
